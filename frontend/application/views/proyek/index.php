...
<body>
    ...
    <a href="<?php echo site_url('lokasi/index'); ?>">Lokasi</a>
    <table>
        <thead>
            <tr>
                <th>Nama Proyek</th>
        ...
        <tbody>
            <?php foreach ($proyek as $item): ?>
                <tr>
                    ...
                    <td><?php echo date('d-m-Y', strtotime($item['tglMulai'])); ?></td>
                    ...
                    <td class="action-links">
                        ...
                        <a href="<?php echo site_url('proyek/delete/' . $item['id']); ?>" class="confirm-delete" onclick="return confirm('Are you sure?');">Delete</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
